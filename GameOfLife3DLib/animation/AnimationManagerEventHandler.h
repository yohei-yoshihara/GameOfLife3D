#ifndef ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_
#define ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_
...
namespace animation {
  ...
  public:
    static COM_DECLSPEC_NOTHROW HRESULT CreateInstance(std::weak_ptr<animation::IAnimationWindow> animationWindow,
...
#endif // ANIMATION_ANIMATIONMANAGEREVENTHANDLER_H_