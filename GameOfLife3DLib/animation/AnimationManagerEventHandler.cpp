...
animation::AnimationManagerEventHandler::CreateInstance(std::weak_ptr<animation::IAnimationWindow> animationWindow,
...
HRESULT animation::AnimationManagerEventHandler::OnManagerStatusChanged(UI_ANIMATION_MANAGER_STATUS newStatus,
