...
#define LOG_HRESULT(sev, hr) BOOST_LOG_SEV(get_logger(),sev) << __FUNCTION__ << L"(" << __LINE__ << L") - " << L"HRESULT = " << std::hex << hr << std::dec << L", "
...
#define LOG_LEAVE_HRESULT(sev, hr) BOOST_LOG_SEV(get_logger(),sev) << __FUNCTION__ << L"(" << __LINE__ << L") <LEAVE> - " << std::hex << L"HRESULT = " << hr << std::dec
