...
const SHORT graphics::filter::FilterCommon::INDEX_ARRAY[] = {
    3, 1, 0,
    2, 1, 3
};

const UINT graphics::filter::FilterCommon::INDEX_ARRAY_BYTEWIDTH =
    sizeof(graphics::filter::FilterCommon::INDEX_ARRAY);
