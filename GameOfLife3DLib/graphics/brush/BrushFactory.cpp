...
std::shared_ptr<graphics::brush::IBrush>
graphics::brush::BrushFactory::Create(ID2D1RenderTarget *pRenderTarget, std::shared_ptr<graphics::color::IColor> color,
  ...
  case graphics::color::IColor::COLOR_TYPE_SOLID_COLOR: {
    ...
    auto solidColorBrush = std::make_shared<graphics::brush::SolidColorBrush>(solidColor->GetCurrentColor());
  ...
  case graphics::color::IColor::COLOR_TYPE_LINEAR_GRADIENT_COLOR: {
    ...
    auto linearGradientBrush = std::make_shared<graphics::brush::LinearGradientBrush>();
  ...
  case graphics::color::IColor::COLOR_TYPE_RADIAL_GRADIENT_COLOR: {
    ...
    auto radialGradientBrush = std::make_shared<graphics::brush::RadialGradientBrush>();
    radialGradientBrush->SetGradientOriginOffsetRate(radialGradientColor->GetGradientOffsetX(),
