...
HRESULT graphics::brush::SolidColorBrush::CreateDeviceDependentResource(
    ...
    FLOAT opacity)
{
    ...
    m_brush = nullptr;
    CHK_FATAL_HRESULT(pRenderTarget->CreateSolidColorBrush(m_color,
                      D2D1::BrushProperties(opacity), &m_brush));
