...
HRESULT graphics::figure::EllipseFigure::Initialize(
    graphics::D3DInteropHelper *pD3DInteropHelper)
{
    ...
    CHK_FATAL_HRESULT(pD3DInteropHelper->GetD2DFactory()->CreateEllipseGeometry(
                          D2D1::Ellipse(D2D1::Point2F(m_width / 2.0f, m_height / 2.0f),
    ...
    for (size_t i = 0; i < m_brushes->GetNumberOfBrushes(); ++i) {
        ...
        CHK_FATAL_HRESULT(pD3DInteropHelper->GetD2DFactory()->CreateEllipseGeometry(
                              D2D1::Ellipse(D2D1::Point2F(m_width / 2.0f, m_height / 2.0f),
                                            m_width / 2.0f - offset, m_height / 2.0f - offset),
                              &m_frames[i]
                          ));
    }
...
HRESULT graphics::figure::EllipseFigure::CreateDeviceDependentResources(
    graphics::D3DInteropHelper *pD3DInteropHelper,
...
HRESULT graphics::figure::EllipseFigure::Render(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget,
    FLOAT opacity)
{
...
void graphics::figure::EllipseFigure::SetColor(
