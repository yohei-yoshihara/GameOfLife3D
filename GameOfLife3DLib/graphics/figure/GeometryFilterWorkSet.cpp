...
graphics::figure::GeometryFilterWorkSet::GeometryFilterWorkSet(
    const std::wstring &workSetName, const std::wstring &filterName,
    graphics::figure::FILTER_DISPLAY_ORDER filterDisplayOrder, std::shared_ptr<graphics::color::IColor> color)
