...
public:
    ...
    bool operator==(const ColorValue& colorValue) const {
        return m_colorType == colorValue.m_colorType &&
               m_value1 == colorValue.m_value1 &&
               m_value2 == colorValue.m_value2 &&
               m_value3 == colorValue.m_value3 &&
               m_alpha == colorValue.m_alpha;
    ...
    ColorValue CloneAndBrighter(FLOAT rate) const {
        return ColorValue(
                   ...
                   GetHue(),
                   GetSaturation(),
                   saturate(GetBrightness() * (1.0f + rate), 1.0f),
                   GetAlpha());
    }
    ...
    friend std::wostream& operator<<(std::wostream& os, ColorValue const& colorValue) {
        ...
        case graphics::color::ColorValue::COLOR_TYPE_RGBA:
            os << L"[colorType=RGBA,red=" << colorValue.m_value1
               << L",green=" << colorValue.m_value2
               << L",blue=" << colorValue.m_value3
               << L",alpha=" << colorValue.m_alpha
               << L"]";
            break;
        case graphics::color::ColorValue::COLOR_TYPE_HSBA:
            os << L"[colorType=HSBA,hue=" << colorValue.m_value1
               << L",saturation=" << colorValue.m_value2
               << L",brightness=" << colorValue.m_value3
               << L",alpha=" << colorValue.m_alpha
               << L"]";
            break;
        default:
    ...
    friend std::ostream& operator<<(std::ostream& os, ColorValue const& colorValue) {
        ...
        switch (colorValue.m_colorType) {
        case graphics::color::ColorValue::COLOR_TYPE_RGBA:
            os << "[colorType=RGBA,red=" << colorValue.m_value1
               << ",green=" << colorValue.m_value2
               << ",blue=" << colorValue.m_value3
               << ",alpha=" << colorValue.m_alpha
               << "]";
            break;
        case graphics::color::ColorValue::COLOR_TYPE_HSBA:
            os << "[colorType=HSBA,hue=" << colorValue.m_value1
               << ",saturation=" << colorValue.m_value2
               << ",brightness=" << colorValue.m_value3
               << ",alpha=" << colorValue.m_alpha
               << "]";
            break;
        default:
