...
void graphics::color::ColorPatternUtil::GeneratePattern(
    IN COLOR_PATTERN colorPattern, IN const graphics::color::ColorValue &color,
  ...
  case COLOR_PATTERN_FLAT:
    ...
    brushes[0]->AddGradientStop(D2D1::GradientStop(0.0, color.ToD2D1_COLOR_F()));
    brushes[0]->AddGradientStop(D2D1::GradientStop(1.0, color.ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_GRADIENT:
    ...
    brushes[0] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[0]->SetGradientDirection(graphics::GRADIENT_DIRECTION_TOP_BOTTOM);
    brushes[0]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.4f).ToD2D1_COLOR_F()));
    brushes[0]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.4f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_CONVEX:
    ...
    brushes[1]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.2f).ToD2D1_COLOR_F()));
    brushes[1]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.2f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_CONCAVE:
    ...
    brushes[0] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[0]->SetGradientDirection(graphics::GRADIENT_DIRECTION_TOPLEFT_TO_BOTTOMRIGHT);
    brushes[0]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndDarker(0.4f).ToD2D1_COLOR_F()));
    brushes[0]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndBrighter(0.4f).ToD2D1_COLOR_F()));

    brushes[1] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[1]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndDarker(0.2f).ToD2D1_COLOR_F()));
    brushes[1]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndBrighter(0.2f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_CONVEX_FRAME:
    ...
    brushes[0] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[0]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));
    brushes[0]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));

    brushes[1] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[1]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));
    brushes[1]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));

    brushes[2] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[2]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.2f).ToD2D1_COLOR_F()));
    brushes[2]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.2f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_CONCAVE_FRAME:
    ...
    brushes[0] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[0]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));
    brushes[0]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));

    brushes[1] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[1]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));
    brushes[1]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_FRAME:
    ...
    brushes[2] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[2]->AddGradientStop(D2D1::GradientStop(0.0, color.ToD2D1_COLOR_F()));
    brushes[2]->AddGradientStop(D2D1::GradientStop(1.0, color.ToD2D1_COLOR_F()));

    brushes[3] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[3]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));
    brushes[3]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndBrighter(0.3f).ToD2D1_COLOR_F()));

    brushes[4] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[4]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));
    brushes[4]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.3f).ToD2D1_COLOR_F()));

    brushes[5] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[5]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndBrighter(0.2f).ToD2D1_COLOR_F()));
    brushes[5]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndDarker(0.2f).ToD2D1_COLOR_F()));
  ...
  case COLOR_PATTERN_CONVEX_METAL:
    ...
    brushes[2] = std::make_shared<graphics::brush::LinearGradientBrush>();
    brushes[2]->AddGradientStop(D2D1::GradientStop(0.0, color.CloneAndChangeBrightness(0.8f).ToD2D1_COLOR_F()));
    brushes[2]->AddGradientStop(D2D1::GradientStop(0.5, color.CloneAndChangeBrightness(0.55f).ToD2D1_COLOR_F()));
    brushes[2]->AddGradientStop(D2D1::GradientStop(0.5, color.CloneAndChangeBrightness(0.45f).ToD2D1_COLOR_F()));
    brushes[2]->AddGradientStop(D2D1::GradientStop(1.0, color.CloneAndChangeBrightness(0.2f).ToD2D1_COLOR_F()));
