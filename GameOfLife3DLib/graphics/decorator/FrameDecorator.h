...
namespace graphics {
  namespace decorator {
    ...
    public:
      ...
      virtual HRESULT Initialize(graphics::D3DInteropHelper *pD3DInteropHelper, ID2D1Geometry *pGeometry);
      ...
      friend std::wostream &operator<<(std::wostream &os, const graphics::decorator::FrameDecorator &frameDecoration);
    };
  }
}
