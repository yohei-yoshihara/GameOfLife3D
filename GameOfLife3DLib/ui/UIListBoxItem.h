...
class UIListBoxItem :
    public UIBase,
    public std::enable_shared_from_this<UIListBoxItem>
{
public:
...
protected:
    ...
    HRESULT __RecreateAllTextLayout(
        graphics::D3DInteropHelper *pD3DInteropHelper,
        ID2D1RenderTarget *pRenderTarget);
    HRESULT __RecreateMainTextLayout(
        graphics::D3DInteropHelper *pD3DInteropHelper,
        ID2D1RenderTarget *pRenderTarget,
        const std::wstring &text,
        CComPtr<IDWriteTextLayout> &textLayout,
    ...
    HRESULT __RecreateSubTextLayout(
        graphics::D3DInteropHelper *pD3DInteropHelper,
        ID2D1RenderTarget *pRenderTarget,
        const std::wstring &text,
        CComPtr<IDWriteTextLayout> &textLayout,
