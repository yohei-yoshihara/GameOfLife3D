...
STDMETHODIMP ui::UITextStoreACP::RequestLock(
    DWORD dwLockFlags,
    HRESULT *phrSession)
{
...
STDMETHODIMP ui::UITextStoreACP::QueryInsert(
    LONG acpTestStart,
    LONG acpTestEnd,
    ULONG cch,
...
STDMETHODIMP ui::UITextStoreACP::GetSelection(
    ULONG ulIndex,
    ULONG ulCount,
...
STDMETHODIMP ui::UITextStoreACP::SetSelection(ULONG ulCount,
...
STDMETHODIMP ui::UITextStoreACP::GetText(IN LONG acpStart,
        IN LONG acpEnd,
        OUT WCHAR *pchPlain,
...
STDMETHODIMP ui::UITextStoreACP::SetText(
    DWORD dwFlags,
    LONG acpStart,
    LONG acpEnd,
    const WCHAR *pchText,
...
STDMETHODIMP ui::UITextStoreACP::GetFormattedText(
    LONG acpStart,
    LONG acpEnd,
...
STDMETHODIMP ui::UITextStoreACP::GetEmbedded(
    LONG acpPos,
...
STDMETHODIMP ui::UITextStoreACP::QueryInsertEmbedded(
...
STDMETHODIMP ui::UITextStoreACP::InsertEmbedded(
    DWORD dwFlags,
    LONG acpStart,
    LONG acpEnd,
...
STDMETHODIMP ui::UITextStoreACP::RequestSupportedAttrs(
    DWORD dwFlags,
    ULONG cFilterAttrs,
...
STDMETHODIMP ui::UITextStoreACP::RequestAttrsAtPosition(
    LONG acpPos,
    ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs,
    DWORD dwFlags)
...
STDMETHODIMP ui::UITextStoreACP::RequestAttrsTransitioningAtPosition(
    LONG acpPos,
    ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs,
    DWORD dwFlags)
...
STDMETHODIMP ui::UITextStoreACP::FindNextAttrTransition(
    LONG acpStart,
    LONG acpHalt,
    ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs,
...
STDMETHODIMP ui::UITextStoreACP::RetrieveRequestedAttrs(ULONG ulCount,
...
STDMETHODIMP ui::UITextStoreACP::GetACPFromPoint(
    TsViewCookie vcView,
    const POINT *pt,
    DWORD dwFlags,
    LONG *pacp)
...
STDMETHODIMP ui::UITextStoreACP::GetTextExt(
    TsViewCookie vcView,
    LONG acpStart,
    LONG acpEnd,
    RECT *prc,
...
STDMETHODIMP ui::UITextStoreACP::InsertTextAtSelection(
    DWORD dwFlags,
...
STDMETHODIMP ui::UITextStoreACP::InsertEmbeddedAtSelection(DWORD dwFlags,
        IDataObject *pDataObject,
        LONG *pacpStart,
        LONG *pacpEnd,
        TS_TEXTCHANGE *pChange)
...
STDMETHODIMP ui::UITextStoreACP::_TestInsert(
    LONG acpTestStart,
    LONG acpTestEnd,
    ULONG cch,
    LONG *pacpResultStart,
...
HRESULT ui::UITextStoreACP::MoveACPToEnd()
{
    ...
    HRESULT hr = ChangeACPWithoutLock(static_cast<LONG>(GetTextLength()), static_cast<LONG>(GetTextLength()), TS_AE_START);
    _UnlockDocument();
    m_AdviseSink.pTextStoreACPSink->OnLayoutChange(TS_LC_CHANGE, EDIT_VIEW_COOKIE);
    return hr;
}
...
HRESULT ui::UITextStoreACP::OnChar(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    CHAR_TYPE charType,
...
HRESULT ui::UITextStoreACP::OnMouseEvent( FLOAT startX, FLOAT startY, FLOAT endX, FLOAT endY )
{
    ...
    m_editControl.lock()->CalculateSelectionFromDragRect(
        startX, startY, endX, endY, &inside, &acpStart, &acpEnd, &activeSelEnd);
    if (inside) {
        m_acpStart = acpStart;
        m_acpEnd = acpEnd;
        m_ActiveSelEnd = activeSelEnd;
