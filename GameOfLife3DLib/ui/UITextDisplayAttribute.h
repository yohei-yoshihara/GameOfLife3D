#ifndef UI_UITEXTDISPLAYATTRIBUTE_H_
#define UI_UITEXTDISPLAYATTRIBUTE_H_
...
public:
    ...
    bool FindGuid(REFGUID rguid) const {
        return std::any_of(m_guid.begin(), m_guid.end(), [&](REFGUID e) {
...
#endif UI_UITEXTDISPLAYATTRIBUTE_H_