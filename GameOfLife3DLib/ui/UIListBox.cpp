...
void ui::UIListBox::OnLeftMouseDown(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint,
                                    ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  ui::UIContainer::OnLeftMouseDown(hWnd, wParam, lParam, clientPoint, timestampInMilliSeconds, eaten);
}

void ui::UIListBox::OnDraggingStart(HWND hWnd, WPARAM wParam, LPARAM lParam, UI2Points clientDragRect, UIDelta delta,
                                    ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  ui::UIContainer::OnDraggingStart(hWnd, wParam, lParam, clientDragRect, delta, timestampInMilliSeconds, eaten);
}

void ui::UIListBox::OnDragging(HWND hWnd, WPARAM wParam, LPARAM lParam, UI2Points clientDragRect, UIDelta delta,
                               ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  ui::UIContainer::OnDragging(hWnd, wParam, lParam, clientDragRect, delta, timestampInMilliSeconds, eaten);
}

void ui::UIListBox::OnDraggingEnd(HWND hWnd, WPARAM wParam, LPARAM lParam, UI2Points clientDragRect, UIDelta delta,
                                  ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  ui::UIContainer::OnDraggingEnd(hWnd, wParam, lParam, clientDragRect, delta, timestampInMilliSeconds, eaten);
}

void ui::UIListBox::OnMouseOver(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint, UIDelta delta,
                                ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
...
void ui::UIListBox::OnMouseOut(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint, UIDelta delta,
                               ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  UNREFERENCED_PARAMETER(hWnd);
  UNREFERENCED_PARAMETER(wParam);
  UNREFERENCED_PARAMETER(lParam);
...
void ui::UIListBox::OnRightSingleClick(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint,
                                       ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  UNREFERENCED_PARAMETER(hWnd);
  UNREFERENCED_PARAMETER(wParam);
  UNREFERENCED_PARAMETER(lParam);
...
void ui::UIListBox::OnGestureBegin(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint,
...
void ui::UIListBox::OnGestureEnd(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint,
                                 PGESTUREINFO pGestureInfo, ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  UNREFERENCED_PARAMETER(hWnd);
  UNREFERENCED_PARAMETER(wParam);
  UNREFERENCED_PARAMETER(lParam);
...
void ui::UIListBox::OnPan(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint, PGESTUREINFO pGestureInfo,
...
void ui::UIListBox::OnPressAndTap(HWND hWnd, WPARAM wParam, LPARAM lParam, UIPoint clientPoint,
                                  PGESTUREINFO pGestureInfo, ULONGLONG timestampInMilliSeconds, OUT bool *eaten) {
  UNREFERENCED_PARAMETER(hWnd);
  UNREFERENCED_PARAMETER(wParam);
  UNREFERENCED_PARAMETER(lParam);
