...
namespace ui {
  class UIButton : public UIBase, public std::enable_shared_from_this<UIButton> {
  public:
    enum BUTTON_STATUS {
  ...
  public:
    ...
    virtual void SetForegroundColor(const std::vector<D2D1_GRADIENT_STOP> &foregroundColors,
                                    graphics::GRADIENT_DIRECTION fgGradientDirection);
    virtual void SetBackgroundColor(const std::vector<D2D1_GRADIENT_STOP> &backgroundColors,
