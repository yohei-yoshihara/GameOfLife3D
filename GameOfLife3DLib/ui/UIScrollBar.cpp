...
HRESULT ui::UIScrollBar::Initialize(
    graphics::D3DInteropHelper *pD3DInteropHelper )
{
    ...
    m_body->SetColor(
        graphics::color::ColorValue(graphics::color::ColorValue::COLOR_TYPE_HSBA, 0.0f, 0.0f, 0.2f, 1.0f),
        graphics::color::COLOR_PATTERN_CONVEX);
    m_body->SetShadow(true);
    m_body->SetShadowColor(std::make_shared<graphics::color::SolidColor>(graphics::color::ColorValue(
                               graphics::color::ColorValue::COLOR_TYPE_HSBA, 190.0f, 1.0f, 1.0f, 1.0f)));
    ...
    m_arrow1->SetColor(
        graphics::color::ColorValue(graphics::color::ColorValue::COLOR_TYPE_HSBA, 32.0f, 0.0f, 0.5f, 1.0f),
        graphics::color::COLOR_PATTERN_CONVEX);
    ...
    m_bar->SetColor(graphics::color::ColorValue(
                        graphics::color::ColorValue::COLOR_TYPE_HSBA, 190.0f, 1.0f, 0.7f, 1.0f),
                    graphics::color::COLOR_PATTERN_CONVEX_METAL);
    m_bar->SetShadow(true);
    m_bar->SetShadowColor(std::make_shared<graphics::color::SolidColor>(graphics::color::ColorValue(
                              graphics::color::ColorValue::COLOR_TYPE_HSBA, 190.0f, 1.0f, 1.0f, 1.0f)));
...
HRESULT ui::UIScrollBar::CreateDeviceDependentResources(
    graphics::D3DInteropHelper *pD3DInteropHelper,
...
void ui::UIScrollBar::OnLeftMouseDown(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UIPoint clientPoint,
...
void ui::UIScrollBar::OnDraggingStart(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
...
void ui::UIScrollBar::OnDragging(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UI2Points clientDragRect,
    ...
    OUT bool* eaten )
{
    ...
    LOG(SEVERITY_LEVEL_DEBUG) << L"bar[" << m_bar->GetX() << L"," << m_bar->GetY()
                              << L"," << m_bar->GetWidth() << L"x" << m_bar->GetHeight() << L"]";
#endif
    UNREFERENCED_PARAMETER(hWnd);
    UNREFERENCED_PARAMETER(wParam);
    UNREFERENCED_PARAMETER(lParam);
...
void ui::UIScrollBar::OnDraggingEnd(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UI2Points clientDragRect,
...
void ui::UIScrollBar::OnMouseOver(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UIPoint clientPoint,
...
void ui::UIScrollBar::OnMouseOut(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UIPoint clientPoint,
