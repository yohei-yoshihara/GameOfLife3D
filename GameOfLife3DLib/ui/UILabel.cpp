...
HRESULT ui::UILabel::Initialize( graphics::D3DInteropHelper *pD3DInteropHelper )
{
    ...
    CHK_FATAL_HRESULT(pD3DInteropHelper->GetDWriteFactory()->CreateEllipsisTrimmingSign(
                          m_textLayout,
                          &inlineObject
                      ));
    ...
    LOG(SEVERITY_LEVEL_DEBUG) << L"trimming " << trimming3.granularity
                              << L", " << trimming3.delimiter << L", " << trimming3.delimiterCount;
    SafeRelease(&inline3);
#endif
...
HRESULT ui::UILabel::CreateDeviceDependentResources(
    ...
    ID2D1RenderTarget *pRenderTarget )
{
    ...
    CHK_FATAL_HRESULT(m_foregroundColorBrush->CreateDeviceDependentResource(
                          pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()),
                          1.0f));
    return S_OK;
}
...
void ui::UILabel::SetForegroundColor(
...
HRESULT ui::UILabel::Render( graphics::D3DInteropHelper *pD3DInteropHelper, ID2D1RenderTarget *pRenderTarget )
{
    ...
    pRenderTarget->DrawTextLayout(D2D1::Point2F(0.0f, 0.0f),
                                  m_textLayout,
                                  m_foregroundColorBrush->GetBrush(),
