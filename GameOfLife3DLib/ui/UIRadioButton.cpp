    ...
    m_foregroundBrush(std::make_shared<graphics::brush::LinearGradientBrush>())
{
    ...
    m_outerShineBrush->AddGradientStop(
        D2D1::GradientStop(0.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.21f, 1.0f)));
    m_outerShineBrush->AddGradientStop(
        D2D1::GradientStop(1.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.21f, 1.0f)));

    m_innerShadowBrush->AddGradientStop(
        D2D1::GradientStop(0.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.05f, 1.0f)));
    m_innerShadowBrush->AddGradientStop(
        D2D1::GradientStop(1.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.05f, 1.0f)));

    m_innerShineBrush->AddGradientStop(
        D2D1::GradientStop(0.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.25f, 1.0f)));
    m_innerShineBrush->AddGradientStop(
        D2D1::GradientStop(1.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.13f, 1.0f)));

    m_bodyBrush->AddGradientStop(
        D2D1::GradientStop(0.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.13f, 1.0f)));
    m_bodyBrush->AddGradientStop(
        D2D1::GradientStop(1.0, graphics::color::ColorUtil::HsvToRgb(0, 0, 0.13f, 1.0f)));

    m_selectedMarkBrush->AddGradientStop(
        D2D1::GradientStop(0.0, D2D1::ColorF(D2D1::ColorF::White, 1.0f)));
    m_selectedMarkBrush->AddGradientStop(
        D2D1::GradientStop(1.0, D2D1::ColorF(D2D1::ColorF::White, 1.0f)));

    m_foregroundBrush->AddGradientStop(
        D2D1::GradientStop(0.0, D2D1::ColorF(D2D1::ColorF::White, 1.0f)));
    m_foregroundBrush->AddGradientStop(
        D2D1::GradientStop(1.0, D2D1::ColorF(D2D1::ColorF::White, 1.0f)));
}
...
HRESULT ui::UIRadioButton::CreateDeviceDependentResources(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget )
{
    CHK_FATAL_HRESULT(m_outerShineBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
    CHK_FATAL_HRESULT(m_innerShadowBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
    CHK_FATAL_HRESULT(m_innerShineBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
    CHK_FATAL_HRESULT(m_bodyBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
    CHK_FATAL_HRESULT(m_selectedMarkBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
    CHK_FATAL_HRESULT(m_foregroundBrush->CreateDeviceDependentResource(pRenderTarget, D2D1::RectF(0.0f, 0.0f, GetWidth(), GetHeight()), 1.0f));
...
HRESULT ui::UIRadioButton::Render( graphics::D3DInteropHelper *pD3DInteropHelper, ID2D1RenderTarget *pRenderTarget )
{
    ...
    pRenderTarget->FillRectangle(D2D1::RectF(1.0f, 1.0f, textHeight - 1.0f, textHeight - 1.0f), m_innerShadowBrush->GetBrush());
    pRenderTarget->FillRectangle(D2D1::RectF(2.0f, 2.0f, textHeight - 2.0f, textHeight - 2.0f), m_innerShineBrush->GetBrush());
    pRenderTarget->FillRectangle(D2D1::RectF(3.0f, 3.0f, textHeight - 3.0f, textHeight - 3.0f), m_bodyBrush->GetBrush());

    if (m_selected) {
        pRenderTarget->FillRectangle(D2D1::RectF(5.0f, 5.0f, textHeight - 5.0f, textHeight - 5.0f), m_selectedMarkBrush->GetBrush());
    }
...
void ui::UIRadioButton::OnLeftMouseDown(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    UIPoint clientPoint,
