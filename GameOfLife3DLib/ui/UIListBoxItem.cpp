...
const wchar_t *UILISTBOXITEM_DEFAULT_TEXT_COLORSET =
...
const wchar_t *UILISTBOXITEM_DEFAULT_FRAME_COLORSET =
    L"solid(rgba(#353535,1.0))";
...
HRESULT ui::UIListBoxItem::Initialize(graphics::D3DInteropHelper *pD3DInteropHelper)
{
    ...
    // サブテキスト1の初期化
    CHK_WARN_HRESULT(__InitializeSubText(
                         pD3DInteropHelper,
                         m_subText1,
                         m_subText1FontAttribute,
                         m_subText1Format,
                         m_subText1Layout,
                         m_subText1Metrics,
                         m_subText1LayoutRect));
    // サブテキスト2の初期化
    CHK_WARN_HRESULT(__InitializeSubText(
                         pD3DInteropHelper,
                         m_subText2,
                         m_subText2FontAttribute,
                         m_subText2Format,
                         m_subText2Layout,
                         m_subText2Metrics,
                         m_subText2LayoutRect));
#ifdef DEBUG_UILISTBOXITEM
...
HRESULT ui::UIListBoxItem::__InitializeMainText(
    graphics::D3DInteropHelper *pD3DInteropHelper)
{
    ...
    CHK_FATAL_HRESULT(pD3DInteropHelper->GetDWriteFactory()->CreateTextFormat(
                          m_mainTextFontAttribute.fontFamilyName.c_str(),
                          nullptr,
                          m_mainTextFontAttribute.GetFontWeight(),
                          m_mainTextFontAttribute.GetFontStyle(),
                          m_mainTextFontAttribute.GetFontStretch(),
                          m_mainTextFontAttribute.fontSize,
                          L"",
                          &m_mainTextFormat));
    ...
    CHK_FATAL_HRESULT(graphics::DirectWriteUtil::CreateTextLayoutWithTrimming(
                          pD3DInteropHelper->GetDWriteFactory(),
                          m_mainTextFormat,
                          m_mainText.c_str(),
                          m_preferredTextAreaSize.width,
                          m_mainTextNumberOfLines,
                          &m_mainTextLayout
                      ));
    // metrics
...
HRESULT ui::UIListBoxItem::__InitializeSubText(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ...
    UIRectangle &textRect)
{
    ...
    textFormat = nullptr;
    CHK_FATAL_HRESULT(pD3DInteropHelper->GetDWriteFactory()->CreateTextFormat(
                          fontAttribute.fontFamilyName.c_str(),
                          nullptr,
                          fontAttribute.GetFontWeight(),
                          fontAttribute.GetFontStyle(),
                          fontAttribute.GetFontStretch(),
    ...
    CHK_FATAL_HRESULT(
        pD3DInteropHelper->GetDWriteFactory()->CreateEllipsisTrimmingSign(
            textLayout,
            &inlineObject));
...
void ui::UIListBoxItem::__CalculateLayoutRect()
{
    ...
    if (m_layoutDirection == LAYOUT_DIRECTION_HORIZONTAL) {
        ...
        m_textLayoutRect.width = max3(m_mainTextLayoutRect.width,
                                      m_subText1LayoutRect.width,
                                      m_subText2LayoutRect.width);
        m_textLayoutRect.height = m_mainTextLayoutRect.height +
                                  m_subText1LayoutRect.height +
                                  m_subText2LayoutRect.height;
...
HRESULT ui::UIListBoxItem::CreateDeviceDependentResources(
    graphics::D3DInteropHelper *pD3DInteropHelper,
...
HRESULT ui::UIListBoxItem::Render(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget )
{
#ifdef DEBUG_UILISTBOXITEM
    ...
    pRenderTarget->DrawTextLayout(
        D2D1::Point2F(m_mainTextLayoutRect.x, m_mainTextLayoutRect.y),
        m_mainTextLayout,
        m_textBrushSet->Get(L"mainTextBrush")->GetBrush());
    pRenderTarget->DrawTextLayout(
        D2D1::Point2F(m_subText1LayoutRect.x, m_subText1LayoutRect.y),
        m_subText1Layout,
        m_textBrushSet->Get(L"subText1Brush")->GetBrush());
    pRenderTarget->DrawTextLayout(
        D2D1::Point2F(m_subText2LayoutRect.x, m_subText2LayoutRect.y),
        m_subText2Layout,
...
HRESULT ui::UIListBoxItem::__RecreateAllTextLayout(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget)
{
#ifdef DEBUG_UILISTBOXITEM
    LOG_ENTER(SEVERITY_LEVEL_DEBUG);
#endif
    CHK_WARN_HRESULT(__RecreateMainTextLayout(
                         pD3DInteropHelper,
                         pRenderTarget,
                         m_mainText,
                         m_mainTextLayout,
                         ...
                         m_mainTextLayoutRect,
                         m_mainTextNumberOfLines));
    CHK_WARN_HRESULT(__RecreateSubTextLayout(
                         pD3DInteropHelper,
                         pRenderTarget,
                         m_subText1,
                         m_subText1Layout,
...
HRESULT ui::UIListBoxItem::__RecreateMainTextLayout(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget,
    const std::wstring &text,
    CComPtr<IDWriteTextLayout> &textLayout,
...
HRESULT ui::UIListBoxItem::__RecreateSubTextLayout(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID2D1RenderTarget *pRenderTarget,
    const std::wstring &text,
    CComPtr<IDWriteTextLayout> &textLayout,
