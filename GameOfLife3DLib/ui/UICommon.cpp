...
{
    os << L"UI2Points[start.x=" << points.start.x
       << L",start.y=" << points.start.y
       << L",end.x=" << points.end.x
       << L",end.y=" << points.end.y
       << L"]";
    return os;
}
...
{
    os << L"UIInsets[left=" << insets.left
       << L",top=" << insets.top
       << L",right=" << insets.right
       << L",bottom=" << insets.bottom
       << L"]";
    return os;
}
