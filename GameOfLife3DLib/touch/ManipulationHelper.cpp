...
ManipulationResult touch::ManipulationHelper::OnLeftMouseDownExt(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ...
    timestampInMilliSeconds)
{
    ...
    if (!m_container.expired()) {
        m_container.lock()->OnLeftMouseDown(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
            timestampInMilliSeconds,
            &eaten);
    }
    return eaten ? ManipulationResult(true, true) :
           ManipulationResult(false, false);
}

ManipulationResult touch::ManipulationHelper::OnLeftMouseUpExt(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ULONGLONG timestampInMilliSeconds )
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnLeftMouseUp(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
ManipulationResult touch::ManipulationHelper::OnSingleClick(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ULONGLONG timestampInMilliSeconds)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnSingleClick(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
ManipulationResult touch::ManipulationHelper::OnDoubleClick(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ULONGLONG timestampInMilliSeconds)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnDoubleClick(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
ManipulationResult touch::ManipulationHelper::OnDraggingStart(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    RECT windowDragRect,
    ...
    ULONGLONG timestampInMilliSeconds)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnDraggingStart(
            hWnd,
            wParam,
            lParam,
            static_cast<UI2Points>(windowDragRect),
...
ManipulationResult touch::ManipulationHelper::OnDragging(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    RECT windowDragRect,
...
ManipulationResult touch::ManipulationHelper::OnDraggingEnd(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    RECT windowDragRect,
    ...
    ULONGLONG timestampInMilliSeconds)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnDraggingEnd(
            hWnd,
            wParam,
            lParam,
            static_cast<UI2Points>(windowDragRect),
...
ManipulationResult touch::ManipulationHelper::OnMouseOver(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult touch::ManipulationHelper::OnMouseOut(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult touch::ManipulationHelper::OnRightSingleClick(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ...
    timestampInMilliSeconds)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnRightSingleClick(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
ManipulationResult touch::ManipulationHelper::OnGestureBegin(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ...
    PGESTUREINFO pGestureInfo)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnGestureBegin(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
ManipulationResult touch::ManipulationHelper::OnGestureEnd(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult touch::ManipulationHelper::OnZoom(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult touch::ManipulationHelper::OnPan(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult touch::ManipulationHelper::OnRotate(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
...
ManipulationResult
touch::ManipulationHelper::OnTwoFingerTap(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ...
    PGESTUREINFO pGestureInfo)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnTwoFingerTap(
            hWnd, wParam, lParam,
            static_cast<UIPoint>(windowPoint),
            pGestureInfo,
            timestampInMilliSeconds,
...
ManipulationResult
touch::ManipulationHelper::OnPressAndTap(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    POINT windowPoint,
    ...
    PGESTUREINFO pGestureInfo)
{
    ...
    bool eaten = false;
    if (!m_container.expired()) {
        m_container.lock()->OnPressAndTap(
            hWnd,
            wParam,
            lParam,
            static_cast<UIPoint>(windowPoint),
...
touch::ManipulationResult touch::ManipulationHelper::OnChar(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    CHAR_TYPE charType,
...
touch::ManipulationResult touch::ManipulationHelper::OnSetFocus(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    ULONGLONG timestampInMilliSeconds )
...
touch::ManipulationResult touch::ManipulationHelper::OnKillFocus(
    HWND hWnd,
    WPARAM wParam,
    LPARAM lParam,
    ULONGLONG timestampInMilliSeconds )
