    ...
    UINT maxNumberOfGenerations, FLOAT marginRate)
{
    ...
    XMFLOAT3 p0;
    XMFLOAT3 p1;
    Draw3DUtil::CalculateP0P1(
        pLifeSimulator->GetWidth(), pLifeSimulator->GetHeight(), maxNumberOfGenerations,
        p0, p1);
...
HRESULT gameOfLife3D::draw3d::Draw3DWithCPU::MoveNextGeneration(
    graphics::D3DInteropHelper *pD3DInteropHelper)
{
...
HRESULT gameOfLife3D::draw3d::Draw3DWithCPU::CreateD3DResources(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ...
    ID3D11DeviceContext *pImmediateContext )
{
    ...
    CHK_FATAL_HRESULT(
        pD3DInteropHelper->CompileShaderFromResource(
            MAKEINTRESOURCE(IDR_SHADER_SIMPLE_D3D), "VS", "vs_4_0", &pVSBlob));
    CHK_FATAL_HRESULT(
    ...
    CHK_FATAL_HRESULT(pD3DInteropHelper->CompileShaderFromResource(
                          MAKEINTRESOURCE(IDR_SHADER_SIMPLE_D3D), "PS", "ps_4_0", &pPSBlob));
...
HRESULT gameOfLife3D::draw3d::Draw3DWithCPU::RecreateSizedResources(
    UINT nWidth,
    UINT nHeight,
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID3D11Device *pDevice,
...
HRESULT gameOfLife3D::draw3d::Draw3DWithCPU::Draw3D(
    graphics::D3DInteropHelper *pD3DInteropHelper,
    ID3D11Device *pDevice,
    ID3D11DeviceContext *pImmediateContext )
{
