...
void gameOfLife3D::draw3d::Draw3DUtil::CalculateP0P1(UINT width, UINT height, UINT generations, OUT XMFLOAT3 &p0,
                                                     OUT XMFLOAT3 &p1) {
  FLOAT n = static_cast<FLOAT>(std::max(std::max(width, height), generations));
...
void gameOfLife3D::draw3d::Draw3DUtil::CalculateLengthAndMargin(UINT width, UINT height, UINT generations, XMFLOAT3 p0,
                                                                XMFLOAT3 p1, FLOAT marginRate, OUT XMFLOAT3 &cubeLength,
                                                                OUT XMFLOAT3 &cubeMargin) {
  if (width == 1) {
