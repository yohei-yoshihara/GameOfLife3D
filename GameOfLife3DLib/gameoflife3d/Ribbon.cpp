...
HRESULT gameOfLife3D::Ribbon::OnViewChanged(
    UINT32 nViewID,
...
HRESULT gameOfLife3D::Ribbon::OnCreateUICommand(
    UINT32 nCmdID,
...
HRESULT gameOfLife3D::Ribbon::OnDestroyUICommand(
    UINT32 commandId,
    __in UI_COMMANDTYPE typeID,
...
HRESULT gameOfLife3D::Ribbon::Execute(
    UINT nCmdID,
...
HRESULT gameOfLife3D::Ribbon::UpdateProperty(
    UINT nCmdID,
